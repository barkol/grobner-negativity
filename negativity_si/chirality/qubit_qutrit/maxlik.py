"""
Two-Stage Maximum Likelihood Estimation for Qubit-Qutrit Chirality Witness.
...
class ChiralityMaxLikEstimator:
    """
    Two-Stage Maximum Likelihood Estimator for qubit-qutrit chirality witness.
    ...
    def calibrate(self) -> dict:
        """Stage 1: Calibrate f_I2, f_M2, p using KNOWN theta values."""
        if not self.states:
    ...
    def fit_theta(self, state: StateData) -> dict:
        """Stage 2: Fit theta using calibrated f_I2, f_M2, p."""
    ...
    def print_results(self, results: Optional[dict] = None) -> None:
        ...
        print("=" * 80)
        print("TWO-STAGE ML ESTIMATION FOR QUBIT-QUTRIT CHIRALITY WITNESS")
        print("=" * 80)
